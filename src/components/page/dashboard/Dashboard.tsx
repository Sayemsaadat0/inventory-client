...
const WeatherInfo = () => {
  const [weatherInfo, setWeatherInfo] = useState<watherForcastType | undefined>(
    undefined
  );
        ...
        <div className="flex gap-2 lg:justify-end">
          ...
          <div className="bg-black/60 p-5 flex flex-col items-center justify-between backdrop-blur-sm  w-full lg:min-w-72 min-h-72 rounded-[10px] text-center  weatherFont">
            <p className="text-2xl">
              Weather today at <br /> {weatherInfo.name}
            </p>
            <p>
              <span className="font-bold text-7xl">{weatherInfo.temp}</span>
    ...
    <div className=" space-y-10 ">
      <div className="flex flex-col xl:flex-row justify-between gap-2">
        <div className=" overflow-hidden relative bg-black/60 backdrop-blur-sm w-full rounded-[10px] p-3 flex flex-col justify-center gap-5">
          <p>
            {" "}
            <span className="opacity-80 text-2xl ">Welcome back, </span>{" "}
          ...
          <p className="w-[80%]">
            ...
            officiis nisi harum ratione nulla voluptas iste temporibus et
            dolores inventore! lorem50
          </p>
          ...
          <div className="absolute opacity-50 bottom-0 right-0">
            ...
            <img
              className="w-60"
              src="https://i.ibb.co.com/0VdSgYk/Untitled-design-5.png"
            />
          </div>
        </div>
        <div>
